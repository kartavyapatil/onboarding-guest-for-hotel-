...
import {useLoginUserMutation} from './query/Authuser.query'
  ...
  return (
    <>
      <div className='flex justify-between  items-center  h-[10vh] bg-slate-50'>
        ...
        <div>
          <button onClick={loginguest} className='m-8 p-2 border bg-blue-400 rounded-lg border-blue-950' >Guest Login</button>
        </div>
      </div>
      <div className=' flex gap-1 justify-center  bg-slate-50'>
        <div className='w-[45vw]  h-[69.5vh] '>
          <div className='rounded-lg  p-10 bg-white w-full h-[58vh] mt-8'>
            <div className='text-3xl font-serif font-medium flex justify-center p-4'>Admin Login</div>
